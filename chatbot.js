/* =====================================================================
   chatbot.js — Hawaii Wiring Tech Electrical Chatbot
   ▸ Fully self-contained: injects its own CSS, HTML, and AI logic.
   ▸ Auto-reveals 3 s after page load via setTimeout.
   ▸ Also exposed as window.showChatbot(scroll) for any future lead forms.
...
(function () {
  ...
  style.textContent = [
    '#chat-section{display:none;background:#f0f6ff;padding:60px 20px}',
    '.chat-wrap{max-width:600px;margin:0 auto}',
    '.chat-head{text-align:center;margin-bottom:24px}',
    ".chat-head h2{font-family:'Segoe UI',Tahoma,Geneva,Verdana,sans-serif;font-size:2rem;font-weight:900;color:#0f1e3a;margin-bottom:4px}",
    ...
    '.chat-bar{background:#0f1e3a;color:white;padding:13px 18px;display:flex;align-items:center;gap:10px;font-weight:600;font-size:.9rem}',
    ...
    '.msg.bot .av{background:#0f1e3a;color:white}',
    '.msg.user .av{background:#00a8ff;color:white}',
    '.bbl{max-width:78%;padding:9px 13px;border-radius:10px;font-size:.87rem;line-height:1.5}',
    '.msg.bot .bbl{background:#f1f5f9;color:#0f1e3a}',
    '.msg.user .bbl{background:#00a8ff;color:white}',
    '.typing{display:none;align-items:center;gap:8px;padding:0 18px 10px}',
    '.typing .av{width:30px;height:30px;border-radius:50%;background:#0f1e3a;color:white;display:flex;align-items:center;justify-content:center;font-size:.8rem}',
    ...
    "#msg-input{flex:1;padding:9px 12px;border:1.5px solid #e2e8f0;border-radius:8px;font-family:'Segoe UI',Tahoma,Geneva,Verdana,sans-serif;font-size:.9rem;outline:none}",
    '#msg-input:focus{border-color:#00a8ff}',
    '#msg-send{background:#00a8ff;color:white;border:none;border-radius:8px;padding:9px 16px;cursor:pointer;font-weight:600;font-size:.9rem}',
    '#msg-send:hover{background:#0088cc}',
  ...
  section.setAttribute('aria-label', 'Electrical Services Chat Assistant');
  section.innerHTML =
    '<div class="chat-wrap">' +
      '<div class="chat-head">' +
        '<h2>&#x26A1; Ask Our Electrical Assistant</h2>' +
        '<p>Have electrical questions? We\'re here to help 24/7.</p>' +
      '</div>' +
      '<div class="chat-box" role="log" aria-live="polite">' +
        '<div class="chat-bar"><div class="dot" aria-hidden="true"></div>&#x26A1; Hawaii Wiring Tech Assistant</div>' +
        '<div class="msgs" id="msgs">' +
          '<div class="msg bot">' +
            '<div class="av" aria-hidden="true">&#x1F916;</div>' +
            '<div class="bbl">Aloha! &#x1F33A; I\'m your Hawaii Wiring Tech electrical assistant. Ask me anything about electrical repairs, panel upgrades, EV charger installation, smart home wiring, commercial electrical work, and more!</div>' +
          '</div>' +
        '</div>' +
        ...
        '<div class="chat-input">' +
          ...
          '<input type="text" id="msg-input" placeholder="Ask an electrical question..." aria-label="Chat message">' +
  ...
  var SYSTEM = 'You are a friendly electrical services customer assistant for Hawaii Wiring Tech, a licensed electrician company serving Hawaii. ' +
    'Help customers with questions about electrical repairs, panel upgrades, circuit breakers, outlets, wiring, EV charger installation, ' +
    'smart home and automation wiring, commercial electrical work, safety inspections, permits, and scheduling. ' +
    'Be warm and professional. Use Aloha or Mahalo occasionally. ' +
    'Keep answers to 2-3 sentences. Do not use markdown formatting. ' +
    'If asked about something unrelated to electrical services, politely redirect back to electrical topics. ' +
    'The company phone number is 808-780-4086.';
  ...
  function send() {
    ...
    .catch(function () {
      document.getElementById('typing').style.display = 'none';
      addMsg('Sorry, I had trouble responding. Please try again or call us at 808-780-4086!', 'bot');
      document.getElementById('msg-send').disabled = false;
    });
  }
